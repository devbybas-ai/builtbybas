...
8. **Prohibited Actions** — Full list from Site Health Plan "Prohibited Actions" section plus any project-specific additions
...
- Score all 12 dimensions (see Section 7)
...
- [ ] Claude runs: Pre-Build Readiness Audit (12 dimensions)
