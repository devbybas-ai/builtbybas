...
export default function OrderTrackingPage() {
  ...
  const outForDeliveryOrder = orders.find((o) => o.status === "out-for-delivery");
  ...
  return (
    <PageWrapper>
      ...
      >
        <StatCard label="Active Orders" value={activeCount} icon={Package} color="amber" />
        <StatCard
        ...
        />
        <StatCard label="Delivered" value={deliveredCount} icon={CheckCircle} color="emerald" />
        <StatCard
          label="Total Value"
