...
export const folders = [
  { id: "1", name: "Human Resources", icon: "👥", fileCount: 24, updated: "2026-03-09", color: "violet" },
  { id: "2", name: "Finance", icon: "💰", fileCount: 67, updated: "2026-03-10", color: "emerald" },
  { id: "3", name: "Legal", icon: "⚖️", fileCount: 31, updated: "2026-03-05", color: "amber" },
  { id: "4", name: "Marketing", icon: "📢", fileCount: 89, updated: "2026-03-08", color: "rose" },
  { id: "5", name: "Engineering", icon: "⚙️", fileCount: 142, updated: "2026-03-10", color: "cyan" },
  { id: "6", name: "Operations", icon: "🏭", fileCount: 38, updated: "2026-03-07", color: "amber" },
  { id: "7", name: "Sales", icon: "📈", fileCount: 56, updated: "2026-03-09", color: "emerald" },
  { id: "8", name: "Product", icon: "🎯", fileCount: 73, updated: "2026-03-10", color: "violet" },
];
...
// ---- ORDER TRACKING ----
export const orders = [
  { id: "ORD-2026-041", product: "Logitech MX Keys (×20)", vendor: "TechSupply Pro", ordered: "2026-03-08", estimated: "2026-03-12", status: "out-for-delivery", tracking: "1Z999AA10123456784", value: 1799.80, stages: ["ordered", "confirmed", "processing", "shipped", "out-for-delivery", "delivered"] },
  { id: "ORD-2026-038", product: "Herman Miller Aeron Chair (×5)", vendor: "Herman Miller Direct", ordered: "2026-03-05", estimated: "2026-03-18", status: "shipped", tracking: "1Z999AA10987654321", value: 7475.00, stages: ["ordered", "confirmed", "processing", "shipped", "out-for-delivery", "delivered"] },
