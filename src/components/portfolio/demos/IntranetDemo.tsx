...
import { demoStaggerContainer, demoStaggerItem, demoFadeUp, demoScalePop, demoSprings } from "@/lib/demo-motion";
...
export function IntranetDemo() {
  ...
  return (
    <DemoPageWrapper>
      ...
      >
        <DemoStatCard label="Team Members" value="12" icon={Users} color="cyan" />
        <DemoStatCard label="Announcements" value="6" icon={Megaphone} color="violet" trend={{ value: "2 pinned", up: true }} />
        <DemoStatCard label="Documents" value="447" icon={FolderOpen} color="emerald" />
        <DemoStatCard label="Departments" value="10" icon={Briefcase} color="amber" />
      </motion.div>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2 mb-1">
                            ...
                            <div className="flex items-center gap-1.5 flex-shrink-0">
                              <span className={`demo-badge text-[9px] ${categoryColors[ann.category] || "text-white/50 bg-white/10"}`}>
                                {ann.category}
                              </span>
                              <motion.div
              ...
              >
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    <DemoSearchBar value={search} onChange={setSearch} placeholder="Search by name or title..." />
                  </div>
                  <select
                    value={deptFilter}
                    onChange={(e) => setDeptFilter(e.target.value)}
                    className="demo-glass rounded-lg px-3 py-2 text-xs text-white/70 outline-none"
                ...
                <motion.div variants={demoStaggerContainer} initial="hidden" animate="visible" className="space-y-2">
                  {filteredEmployees.map((emp) => (
                    <motion.div
                      ...
                      className="demo-glass rounded-xl p-3 cursor-pointer flex items-center gap-3"
                    >
                      <motion.div
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          {emp.status === "on-leave" && (
                            <span className="demo-badge text-[9px] text-amber-400 bg-amber-400/10">On Leave</span>
                          )}
                        </div>
                  ...
                  {companyDocs.map((doc) => {
                    ...
                    return (
                      <motion.div
                        ...
                        whileHover={{ scale: 1.01, x: 2 }}
                        transition={demoSprings.snappy}
                        className="demo-glass rounded-xl p-3 flex items-center gap-3 cursor-pointer"
                      >
        ...
        {selectedEmployee && (
          ...
          >
            <motion.div
              ...
              transition={demoSprings.smooth}
              className="demo-glass rounded-2xl p-6 w-full max-w-sm"
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="demo-badge text-[9px] text-cyan-400 bg-cyan-400/10 mt-1">{selectedEmployee.dept}</span>
                  </div>
                </div>
                <motion.button
                ...
                {[
                  ...
                  return (
                    <motion.div
                      ...
                      initial={{ opacity: 0, x: -10 }}
                      animate={{ opacity: 1, x: 0 }}
                      transition={{ ...demoSprings.smooth, delay: i * 0.08 }}
