...
export function CTASection({
  ...
  const content = (
    <div className="group relative">
      <div className="glass-card relative px-8 py-16 text-center transition-all duration-700 hover:border-primary/20 hover:shadow-[0_0_60px_-10px] hover:shadow-primary/10 sm:px-16">
        {/* Background decorative elements */}
        <div className="pointer-events-none absolute -left-20 -top-20 h-40 w-40 rounded-full bg-primary/5 blur-3xl" />
